...
mraid.getStringExpandProperties = function() {
    log.i("mraid.getStringExpandProperties");
...
mraid.getStringOrientationProperties = function() {
// log.i("mraid.getOrientationProperties");
 return JSON.stringify(orientationProperties);
};
